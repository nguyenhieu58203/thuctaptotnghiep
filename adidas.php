      ...
      <div class="left2"><b>COLLECTION</b><br><br>
        <table align="left"  >
          ...
          <div id="right"><br><br><br><br>
            <div align="center"><h1 style="font-size: 45px; color: white; background-color: black; font-family: Verdana, Geneva, Tahoma, sans-serif;">ADIDAS</h1></div><br>
            <p style="vertical-align: top; text-align: right; font-size: 15px;">CÓ 15 SẢN PHẨM VÀ BÀI VIẾT CÓ TỪ KHÓA "TÌM KIẾM: ĐÃ TÌM THẤY 15 KẾT QUẢ CHO "ADIDAS"</p><br><br>
            <div class="product" align="center">
              <div class="container">
                  <div class="product-Items">
                      <div class="product-Item" >
                          <img src="IMG/a1.jpg" width="250px" height="250px">
                          <p class="test2">Adidas Stan Smith Navy</b><br>
                              <p class="tien"><span>1.750.000</span> <sup>đ</sup></p>
                              <button class="giohang">THÊM VÀO GIỎ HÀNG</button>
                      </div>
                      <div class="product-Item">
                          <img src="IMG/a2.jpg" width="250px" height="250px">
                          <p class="test2">Adidas N5923 Black</b><br>
                              <p class="tien"><span>1.100.000</span> <sup>vnđ</sup></p>
                              <button class="giohang">THÊM VÀO GIỎ HÀNG</button>
                      </div>
                      <div class="product-Item" >
                          <img src="IMG/a3.jpg" width="250px" height="250px">
                          <p class="test2">Adidas ZX Flux Xeno Green</b><br>
                              <p class="tien"><span>2.750.000</span><sup>vnđ</sup></p>
                              <button class="giohang">THÊM VÀO GIỎ HÀNG</button>
                      </div>
                      <div class="product-Item">
                          <img src="IMG/a4.jpg" width="250px" height="250px">
                          <p class="test2">ADIDAS Essential Crew Black</b><br>
                              <p class="tien"><span>990.000</span> <sup>vnđ</sup></p>
                              <button class="giohang">THÊM VÀO GIỎ HÀNG</button>
                      </div>
                      <div class="product-Item">
                          <img src="IMG/a5.jpg" width="250px" height="250px" >
                          <p class="test2">Adidas Essential Hoodie White</b><br>
                              <p class="tien"><span>950.000</span> <sup>vnđ</sup></p>
                              <button class="giohang">THÊM VÀO GIỎ HÀNG</button>
                      </div>
                  </div>
              </div>
              <div class="product" align="left">
                <div class="container">
                    <div class="product-Items">
                        <div class="product-Item" >
                            <img src="IMG/a6.jpg" width="250px" height="250px" >
                            <p class="test2">Adidas NMD Burgundy</b><br>
                                <p class="tien"><span>2.200.000</span> <sup>vnđ</sup></p>
                                <button class="giohang">THÊM VÀO GIỎ HÀNG</button>
                        </div>
                        <div class="product-Item">
                            <img src="IMG/a7.jpg" width="250px" height="250px" >
                            <p class="test2">Adidas Adilette 22 Slides Crystal White</b><br>
                                <p class="tien"><span>1.450.000</span> <sup>vnđ</sup></p>
                                <button class="giohang">THÊM VÀO GIỎ HÀNG</button>
                        </div>
                        <div class="product-Item" >
                            <img src="IMG/a8.jpg" width="250px" height="250px" >
                            <p class="test2">Adidas Adicane Slides Cloud White</b><br>
