      ...
      <div class="left2"><b>COLLECTION</b><br><br>
        <table align="left"  >
          ...
          <div id="right"><br><br><br><br>
            <div align="center"><h1 style="font-size: 45px; color: white; background-color: black; font-family: Verdana, Geneva, Tahoma, sans-serif;">NIKE</h1></div><br>
            <p style="vertical-align: top; text-align: right; font-size: 15px;">CÓ 20 SẢN PHẨM VÀ BÀI VIẾT CÓ TỪ KHÓA "TÌM KIẾM: ĐÃ TÌM THẤY 20 KẾT QUẢ CHO "NIKE"</p><br><br>
            <div class="product" align="center">
              <div class="container">
                  <div class="product-Items">
                    <div class="product-Item" >
                    <img src="IMG/n1.jpg" width="250px" height="250px">
                    <p class="test2">Nike Air Force 1 Shadow White Atmosphere Mint</b><br>
                        <p class="tien"><span>3.550.000</span> <sup>vnđ</sup></p>
                        <button class="giohang">THÊM VÀO GIỎ HÀNG</button>
                </div>
                <div class="product-Item">
                    <img src="IMG/n12.jpg" width="250px" height="250px">
                    <p class="test2">Nike Air Force 1 Low Anniversary White Black</b><br>
                        <p class="tien"><span>4.490.000</span> <sup>vnđ</sup></p>
                        <button class="giohang">THÊM VÀO GIỎ HÀNG</button>
                </div>
                <div class="product-Item" >
                    <img src="IMG/n3.jpg" width="250px" height="250px">
                    <p class="test2">Nike Air Force 1 Low White</b><br>
                        <p class="tien"><span>2.750.000</span><sup>vnđ</sup></p>
                        <button class="giohang">THÊM VÀO GIỎ HÀNG</button>
                </div>
                <div class="product-Item">
                    <img src="IMG/n4.jpg" width="250px" height="250px">
                    <p class="test2">Nike Wmns Air Force 1 07 Essentials Green</b><br>
                        <p class="tien"><span>4.650.000</span> <sup>vnđ</sup></p>
                        <button class="giohang">THÊM VÀO GIỎ HÀNG</button>
                </div>
                <div class="product-Item">
                    <img src="IMG/n5.jpg" width="250px" height="250px" >
                    <p class="test2">Nike Air Force 1 Low 'Valentine's</b><br>
        ...
        <div class="product" align="left">
          <div class="container">
              <div class="product-Items">
                  <div class="product-Item" >
                      <img src="IMG/n6.jpg" width="250px" height="250px" >
                      <p class="test2">Nike Air Force 1 ID 'Gucci'</b><br>
                          <p class="tien"><span>35.200.000</span> <sup>vnđ</sup></p>
                          <button class="giohang">THÊM VÀO GIỎ HÀNG</button>
                  </div>
                  <div class="product-Item">
                      <img src="IMG/n7.jpg" width="250px" height="250px" >
                      <p class="test2">Nike Dunk Low SE 'Just Do It White'</b><br>
                          <p class="tien"><span>5.000.000</span> <sup>vnđ</sup></p>
                          <button class="giohang">THÊM VÀO GIỎ HÀNG</button>
                  </div>
                  <div class="product-Item" >
                      <img src="IMG/sp7.jpg" width="250px" height="250px" >
                      <p class="test2">Nike Kyrie Low 5 Black and white</b><br>
                          <p class="tien"><span>3.200.000</span> <sup>vnđ</sup></p>
                          <button class="giohang">THÊM VÀO GIỎ HÀNG</button>
                  </div>
