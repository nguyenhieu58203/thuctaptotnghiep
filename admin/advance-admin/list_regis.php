...
<body>
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        include('control.php');
                                        $getdata=new data();
                                        $select_all = $getdata->se_all('register');
                                        foreach ($select_all as $se_contact)
                                            {
                                        ?>
                                        <tr>
                                            <td><?php echo $se_contact['id']?></td>
                                            <td><?php echo $se_contact['fullname']?></td>
                                            <td><?php echo $se_contact['username']?></td>
                                            <td><?php echo $se_contact['password']?></td>
                                            <td><?php echo $se_contact['repassword']?></td>
                                            <td><?php echo $se_contact['birth']?></td>
                                            <td><?php echo $se_contact['email']?></td>
                                            <td><?php echo $se_contact['address']?></td>
                                            <td><a href="delete_all.php?del_register=<?php echo $se_contact['id'] ?>"
                                                                        onclick="return(confirm('Bạn chắc chắn muốn xóa'))">
                                            <span class="glyphicon glyphicon-remove"></span></a></td>
                                            <td><a href="up_regis.php?up_regis=<?php echo $se_contact['id'] ?>"
    ...
    <!-- /. WRAPPER  -->
    <div id="footer-sec">
        &copy; 2014 YourCompany | Design By : Hieu 8
    </div>
    <!-- /. FOOTER  -->
